...
**Última coleta:** 2026-08-14T19:58:14+00:00 · **53 coletas** na série (de hora em hora) · **52 instantâneos** guardados

O quadro abaixo é do instantâneo de `2026-08-14T19:58:14+00:00`, com 24/30 sondas conclusivas. Instantâneo com os
...
|---|---|---|---|---|---|---|---|---|---|
| `paulo-marcos-lucio.github.io` | proprio | **3.9** | ✅ | ⚠ meta | — | — | — | ✅ | 78d |
| `github.com` | referencia | **7.5** | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | 47d |
| `www.mozilla.org` | referencia | **7.3** | ✅ | ✅ | ✅ | ✅ | ✅ | ⚠ fora da RFC | 37d |
| `web.dev` | referencia | **6.3** | ✅ | ✅ | ✅ | ✅ | — | — | 58d |
| `www.cloudflare.com` | referencia | barrado na borda | · | · | · | · | · | · | 63d |
| `owasp.org` | referencia | barrado na borda | · | · | · | · | · | · | 52d |
